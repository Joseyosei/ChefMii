...
import {
    ...
    Leaf, Sparkles, Baby, ShoppingBag, Tv, GraduationCap, Gift
} from 'lucide-react'
                                        ...
                                        <>
                                            ...
                                            <div className="px-3 py-2 space-y-1.5">
                                                ...
                                                <button onClick={handleAppleLogin}
                                                    className="w-full flex items-center justify-center gap-2 py-2 bg-black text-white rounded-xl text-xs font-semibold hover:bg-gray-900 transition-colors">
