        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none space-y-6">
            ...
            <section>
              ...
              <p>
                Welcome to ChefMe Global. By accessing or using our platform, you agree to be bound by these Terms of Service. 
            ...
            <section>
              ...
              <p>
                ChefMe Global provides a platform connecting professional chefs with clients seeking culinary services. We 
            ...
            <section>
              ...
              <p>
                All bookings made through ChefMe Global are subject to availability and confirmation by the chef. Payment terms include:
              </p>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>ChefMe Global reserves the right to make exceptions in extraordinary circumstances</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p>
                ChefMe Global acts as a platform connecting chefs and clients. We are not responsible for:
              </p>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>Contact ChefMe Global support for mediation assistance</li>
            ...
            <section>
              ...
              <p>
                ChefMe Global reserves the right to modify these Terms of Service at any time. Changes will be effective 
            ...
            <section>
              ...
              <p className="font-medium">
                Email: legal@chefmeglobal.com<br />
