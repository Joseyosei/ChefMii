...
import { Eye, EyeOff, Mail, Lock, ArrowLeft, Users, User } from "lucide-react";
...
const AdminRegister = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!rateLimiter.check(`admin_register:${email}`, 3, 300000)) {
      toast({
    ...
    if (error) {
      ...
      rateLimiter.reset(`admin_register:${email}`);
      toast({
        title: "Admin Account Created",
        description: "Your administrator account has been successfully registered."
      });
    }
  };
